<div align="center">
  <img src="VibeHUD/Assets.xcassets/AppIcon.appiconset/icon_128x128.png" alt="Logo" width="100" height="100">
  <h3 align="center">VibeHUD</h3>
  <p align="center">
...
```bash
xcodebuild -scheme VibeHUD -configuration Release build
```

## How It Works

VibeHUD installs hooks into `~/.claude/hooks/` that communicate session state via a Unix socket. The app listens for events and displays them in the notch overlay.

When Claude needs permission to run a tool, the notch expands with approve/deny buttons—no need to switch to the terminal.

## Analytics

VibeHUD uses Mixpanel to collect anonymous usage data:
