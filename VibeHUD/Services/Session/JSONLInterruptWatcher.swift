...
private let logger = Logger(subsystem: "com.vibehud", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.vibehud.interruptwatcher", qos: .userInteractive)
